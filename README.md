...
- Select **Ground**, **Walls**, or **Objects**, then click a tile in the sheet. For Objects, select **Paint** and choose Door, Container, or Gatherable. Select **Entities**, choose **Jev AI** or **Player**, then left-click walkable ground to place a creature or right-click to remove one. Press Play to run live Jev; its local proxy starts automatically. In Play/game mode, click a blue Player creature and use arrow keys to move it.
